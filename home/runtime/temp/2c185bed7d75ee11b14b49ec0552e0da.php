<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:68:"C:\myphp_www\PHPTutorial\WWW\tpauth\home\index\view\index\index.html";i:1594288154;}*/ ?>
﻿<!DOCTYPE html>
<html>
    <head>
    ...
    <div class="mini-header-search">
        <div class="container">
            <div class="user-info">
                ...
                <a href="<?php echo U('Index/sow'); ?>" data-title="消息" href="javascript:void(0)">消息</a><span class="separate">|</span>
