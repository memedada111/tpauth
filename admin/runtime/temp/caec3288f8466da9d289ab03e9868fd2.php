<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:69:"C:\myphp_www\PHPTutorial\WWW\tpauth\admin\index\view\index\index.html";i:1594196298;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
<meta charset="utf-8">
		...
		<dl id="menu-system">
			...
			<dd>
				<ul>
					...
					<li><a _href="<?php echo U('Send/sow'); ?>" data-title="消息" href="javascript:void(0)">前端页面消息展示</a></li>
				</ul>
			</dd>
		</dl>
	</div>
