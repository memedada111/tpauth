<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:84:"C:\myphp_www\PHPTutorial\WWW\tpauth\admin\index\view\goods\product_category_add.html";i:1591945432;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
<meta charset="utf-8">
      ...
      <div class="formControls col-5">
        <span class="select-box">
          <select class="select" size="1" name="pid">
            <option value="0" id= "select1" selected>顶级分类</option>
